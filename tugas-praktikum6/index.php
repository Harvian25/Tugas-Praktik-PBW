...
<head>
	...
	<title>Tugas CRUD - PRAKTIKUM 6</title>
</head>
...
<body>
	<section id="awal">
		<nav class="navbar navbar-light fixed-top">
			<div class="container-fluid">
				<a class="navbar-brand" href="#">CIBAYUT</a>
				<button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar">
					<span class="navbar-toggler-icon"></span>
				</button>
				<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
					<div class="offcanvas-header">
						<h5 class="offcanvas-title" id="offcanvasNavbarLabel">SIAKAD.CIBAYUT.AC.ID</h5>
	...
	<section class='landing'>
		<h1>SELAMAT DATANG DI SIAKAD CIBAYUT</h1>
		<h3>Universitas cibaduyut</h3>
		<div class="row">
	...
	<section class="tampil-data" id="tabel">
		<div class="container tampil-data">
			<h2 style="text-align:center;font-weight:bolder;">DATA KRS MAHASISWA CIBAYUT</h2>
			<div class="row">
				<div class="col-12">
